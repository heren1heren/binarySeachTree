 ...
 */
  ...
  insert(value) {
    /* functions that insert/delete the given value. 
     You’ll have to deal with several cases for delete,
  ...
  deleteItem(value) {
     ...
     * You may be tempted to implement these methods using the original input array used to build the tree,
     ...
     we’ll see that binary search trees can insert/delete in O(log n) time, which is a significant performance boost over arrays for the same operations. 
